#ifndef LIBRESOLVER_INCLUDE_CASES_CASE_9_HPP
#define LIBRESOLVER_INCLUDE_CASES_CASE_9_HPP
...
class case_9 : public pattern::match {
   public:
...
#endif /* LIBRESOLVER_INCLUDE_CASES_CASE_9_HPP */