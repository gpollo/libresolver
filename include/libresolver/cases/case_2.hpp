#ifndef LIBRESOLVER_INCLUDE_CASES_CASE_2_HPP
#define LIBRESOLVER_INCLUDE_CASES_CASE_2_HPP
...
class case_2 : public pattern::match {
   public:
...
#endif /* LIBRESOLVER_INCLUDE_CASES_CASE_2_HPP */