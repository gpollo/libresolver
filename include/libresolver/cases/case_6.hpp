#ifndef LIBRESOLVER_INCLUDE_CASES_CASE_6_HPP
#define LIBRESOLVER_INCLUDE_CASES_CASE_6_HPP
...
class case_6 : public pattern::match {
   public:
...
#endif /* LIBRESOLVER_INCLUDE_CASES_CASE_6_HPP */