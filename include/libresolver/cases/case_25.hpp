#ifndef LIBRESOLVER_INCLUDE_CASES_CASE_25_HPP
#define LIBRESOLVER_INCLUDE_CASES_CASE_25_HPP

#include <libresolver/cases/case_base.hpp>

namespace libresolver::cases {

class case_25 : public case_base {
   public:
    case_25(arch arch);
...
#endif /* LIBRESOLVER_INCLUDE_CASES_CASE_25_HPP */