#ifndef LIBRESOLVER_INCLUDE_CASES_CASE_23_HPP
#define LIBRESOLVER_INCLUDE_CASES_CASE_23_HPP

#include <libresolver/cases/case_base.hpp>

namespace libresolver::cases {

class case_23 : public case_base {
   public:
    case_23(arch arch);
...
#endif /* LIBRESOLVER_INCLUDE_CASES_CASE_23_HPP */