#include <libresolver/cases/case_25.hpp>
...
case_25::case_25(arch arch) : case_base("case-25", arch) {}

pattern::tree::pattern case_25::get_pattern() const {
    /*
     * cmp     $k5, %r1d
     * ja      k4
     * lea     k3(%rip),%r2
...
std::unordered_set<uint64_t> case_25::evaluate(const context& context, const memory& memory) const {
