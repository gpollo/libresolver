...
case_18::case_18(arch arch) : case_base("case-18", arch) {}

pattern::tree::pattern case_18::get_pattern() const {
    /*
     * cmp    $k5,%r3d
     * ja     k4
     * lea    k3(%rip),%r2
...
std::unordered_set<uint64_t> case_18::evaluate(const context& context, const memory& memory) const {
