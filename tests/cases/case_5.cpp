...
namespace tests::cases::case_5 {

TEST_CASE("pattern tree should match pattern case 5", "[libresolver::cases::case_5]") {
    x86::engine engine;
    dummy::memory memory;
    ...
    SECTION("example 1") {
        memory.i32_ = {{1112, 10}, {1116, 20}, {1120, 30}, {1124, 40}, {1128, 50}, {1132, 60}, {1136, 70}, {1140, 80}};
