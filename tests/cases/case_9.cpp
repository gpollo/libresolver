...
TEST_CASE("pattern tree should match pattern case 9", "[libresolver::cases::case_9]") {
    x86::engine engine;
    dummy::memory memory;
    ...
    SECTION("example 1") {
        ...
        memory.i32_ = {{1107, 10}, {1111, 20}, {1115, 30}, {1119, 40}, {1123, 50}, {1127, 60}, {1131, 70}, {1135, 80}};
