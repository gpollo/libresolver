...
TEST_CASE("pattern tree should match pattern case 12", "[libresolver::cases::case_12]") {
    x86::engine engine;
    dummy::memory memory;
    ...
    SECTION("example 1") {
        ...
        REQUIRE(context.get(value::VALUE_3).value_or(-1) == 18446744073709547249);
