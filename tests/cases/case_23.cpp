...
namespace tests::cases::case_23 {

TEST_CASE("match-case-23") {
    x86::engine engine;
    dummy::memory memory;
    ...
    SECTION("example 1") {
        memory.i32_ = {{1112, 10}, {1116, 20}, {1120, 30}, {1124, 40}, {1128, 50},
                       {1132, 60}, {1136, 70}, {1140, 80}, {1144, 90}, {1148, 100}};
        ...
        REQUIRE(values.contains(1102));
        REQUIRE(values.contains(1112));
    }
}
